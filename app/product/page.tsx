...
export default function ProductPage() {
  ...
  const images = ["/summariz.png", "/summariz1.png", "/summariz2.png"];

  // Updated Features Array - AI Chat & Summarization Focus
  const features = [
    "Intelligent document summarization & analysis",
    "Multi-format content processing (PDF, Word, Web, Text)",
    "Conversational AI business process consultation",
    "Real-time chat-based solution discovery",
    "Automated insights extraction from business documents",
    "AI-powered executive summary generation",
    "Interactive Q&A for complex business scenarios",
    "Smart categorization and tagging of business processes",
  ];
          ...
          >
            ...
            <div className="space-y-4">
              <p className="text-lg text-slate-300 leading-relaxed">
                Summariz AI is an intelligent chatbot that transforms lengthy
                documents and complex content into clear, concise summaries
                through natural conversation. Simply upload your documents or
                paste text, then chat with our AI to get instant summaries, key
                insights, and answers to specific questions about your content.
                Perfect for busy professionals who need to quickly understand
