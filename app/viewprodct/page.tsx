...
export default function ProductPage() {
  ...
  const images = ["/agent.jpg", "/agent1.jpg", "/agent2.jpg"];

  const features = [
    "Emotional intelligence assessment & tracking",
    "Dual role management (Admin & Doctor access)",
    "Comprehensive emotion categorization system",
    "Personalized response strategy development",
    "Skills-based intervention frameworks",
    "Dynamic statement & context management",
    "Role-based administrative controls",
    "Enhanced patient interaction protocols",
  ];
          ...
          >
            ...
            <div className="space-y-4">
              <p className="text-lg text-slate-300 leading-relaxed">
                The Patient Agent is an application designed to manage emotional
                intelligence and response strategies. It supports two types of
                users: Admin and Doctor. The system allows for comprehensive
                administration of emotions, sections, skills, and statements,
                enhancing personalized interaction and emotional context
                handling.
              </p>
            </div>
